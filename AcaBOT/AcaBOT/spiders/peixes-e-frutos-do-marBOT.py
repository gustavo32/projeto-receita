...
class peixesEfrutosDoMarSpider(scrapy.Spider):
    name = 'peixes-e-frutos-do-marBOT'

    allowed_domains = ['cybercook.uol.com.br']                  #Definindo o domínio de busca
    start_urls = ['https://cybercook.uol.com.br/receitas/peixes-e-frutos-do-mar']
    ...
    def parse_details(self, response):                         #Essa é a função feita específicamente para coletar dados das páginas contendo as receitas
        ...
        data['categoria'] = "peixes-e-frutos-do-mar"                                #Aqui é atribuido a qual categoria esse receita pertence
