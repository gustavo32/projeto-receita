...
ingredientes <- removeWords(ingredientes, c(stopwords("portuguese"),
  ...
  "cadas", "mixer", "úmido", "umidecido", "cs", "polpa", "talo", "talos", "fritar", "precisar", "pétalas", "petalas", 
  ...
  "dependendo", "obsdependendo", "torno", "ia", "alguns ", "tampa", "tampas", "inox", "±", "uso", "pronto", "lasca", 
  "lascas"
))
ingredientes <- stripWhitespace(ingredientes)
ingredientes <- str_trim(ingredientes, "both")
